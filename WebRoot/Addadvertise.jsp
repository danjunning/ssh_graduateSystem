...
<div style="margin-top: 50px">
    <form action="addAdver" class="layui-form" enctype="multipart/form-data" method="post"  id="">
...
<script type="text/javascript">
           ...
           <div class="layui-inline">
             ...
             <div class="layui-input-inline">	
                <select name="subtypeId" required lay-verify="required" lay-search="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="number" name="productPrice" lay-verify="required|" autocomplete="off" class="layui-input" onkeyup="checknum(this)">
                </div>
                <div class="layui-form-mid layui-word-aux"></div>
            </div>
            <script type="text/javascript">
