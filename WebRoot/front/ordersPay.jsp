...
<%	List<Credit> creditList=(List<Credit>)request.getSession().getAttribute("creditList");
	ArrayList<String> ordernumlist=(ArrayList<String>)request.getSession().getAttribute("orderNumlist");
	String address=(String)request.getSession().getAttribute("address");
	Double payMoney=(Double)request.getSession().getAttribute("payMoney");
...
<div class="layui-header" style="">
    ...
    <ul class="layui-nav" style="background: #F5F5F5">
        ...
        <li class="layui-nav-item"><a href="manageList" style="color: #000000">用户<span class="layui-badge-dot"></span></a></li>
...
<div class="web-container">
    ...
    <div class="orderpay-wrap">
        <div class="order-msg">
            <p class="msg-reminder">订单已提交，请在 72小时 内完成付款（逾期自动取消）<b>￥${payMoney }</b></p>
            <p class="msg-order-addr">收货人人信息：${address }</p>
        </div>
       <form  >
        <div class="order-pay-operate">
            <div class="layui-form-item">
                ...
                <%}else{ %>
                <div class="layui-input-block">您还没有添加银行卡</div>
                <%} %>
            </div>
        ...
        <div style="display:none;">
         	<form action="payOrders" id="form_order">
         	<%for(int i=0;i<ordernumlist.size();i++){ %>
         		<input type="text" name="orderNumber" value="<%=ordernumlist.get(i)%>">
         		<%} %>
         		<input type="text" id="payBank" name="payBank" value="">
         		<input type="text" name="price" value="${payMoney }">
